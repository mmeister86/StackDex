...
struct VisionScanPipelineServiceTests {
    ...
    @Test func noisyBodyTextDoesNotDominateStructuredQuery() async throws {
        let fields: [RecognizedCardField] = [
            ...
            .init(text: "199/091", confidence: 0.89, region: .numberBand, boundingBox: CGRect(x: 0.68, y: 0.88, width: 0.2, height: 0.06)),
        ]
...
private enum TestCardImageFactory {
    static func makeCardImage(name: String, collectorNumber: String) -> UIImage {
